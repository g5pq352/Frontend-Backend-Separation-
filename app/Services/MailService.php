...
class MailService {
    ...
    public function sendContactMail($data) {
        ...
        return $this->send([
            'from' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南'],
            'replyTo' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南'],
            'to' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南 - 客戶服務聯繫表單'],
    ...
    public function sendCorporateMail($data) {
        ...
        return $this->send([
            'from' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南'],
            'replyTo' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南'],
            'to' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南 - 企業客制聯繫表單'],
            'subject' => "舊振南 - {$data['name']}",
            'body' => $mailContent
        ]);
    }
    ...
    public function sendWeddingMail($data) {
        ...
        return $this->send([
            'from' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南'],
            'replyTo' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南'],
            'to' => ['email' => 'maysuregun@gmail.com', 'name' => '舊振南 - 喜餅品鑑預約表單'],
            'subject' => "舊振南 - {$data['name']}",
            'body' => $mailContent
        ]);
    }
